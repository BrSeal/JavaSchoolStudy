...
<script src="${pageContext.request.contextPath}/resources/js/employeeDesc/Driver/driverLogic.js" type="text/babel"></script>
<script src="${pageContext.request.contextPath}/resources/js/employeeDesc/Vehicle/vehicleLogic.js" type="text/babel"></script>
<script src="${pageContext.request.contextPath}/resources/js/employeeDesc/Order/orderLogic.js" type="text/babel"></script>
